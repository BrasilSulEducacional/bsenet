        ...
        <div class="boletim-footer">
            <div class="boletim-footer-line" 
                ...
                <span style="width: 200px; display: inline-block;">
                    <b>Média Geral:</b> {{ number_format($mediaGeral, 1, ',', '.') }}
                </span>
                <span style="width: 200px; display: inline-block;">
                    <b>Total Faltas:</b> {{ $totalFaltas }}
                </span>
            </div>
        </div>
    </div>
    <div class="signature" style="margin: 30px 0px 0px 0px; text-align: center; font-size: 1.2em;">
